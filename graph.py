...
class Graph:
    ...
    #returns value of vertices list
    def __iter__(self):
        return iter(self.vertList.values())

    #checks all the nodes at place one from tbeginning node,  checks all the nodes at distance two, etc.
    ...
    #searches of all the nodes by going ahead if possible, if not then it backtracks
    ...
    #checks vertex of  graph avoiding cycles
